...
import { getBanners, updateBanner, deleteBanner, getBannerById, searchBanners } from "../../auth/banner";
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-slate-50/50 rounded-2xl border border-slate-100 space-y-3">
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="text-slate-700 font-semibold">{banner.description}</span>
              </div>
              <div className="flex items-center justify-between text-xs">
                <span className="text-slate-400 font-medium">Status (isActive)</span>
                <span
                ...
                >
                  {banner.isActive === "true" || banner.isActive === true ? "Active" : "Inactive"}
                </span>
              </div>
            </div>
          </div>
...
const BannerManagement = () => {
  ...
  const handleUpdateBanner = async () => {
    if (!selectedBanner.title.trim()) return toast.error("Banner Title is required");
                ...
                banners.map((banner, idx) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-xs">
                      <span className="font-bold text-indigo-500">{banner.position}</span>
                    </td>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    className="w-full bg-slate-50 border border-slate-200 text-slate-600 rounded-xl px-4 py-3 text-xs font-medium focus:outline-none focus:ring-2 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all duration-200"
                    value={String(selectedBanner.isActive)}
                    onChange={(e) => setSelectedBanner({ ...selectedBanner, isActive: e.target.value === "true" })}
                  >
