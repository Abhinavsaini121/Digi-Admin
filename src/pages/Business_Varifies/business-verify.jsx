...
//         setActionLoading(id); // Start loading for this specific ID
//         try {
//             const response = await verifyBusiness(id);
            
//             if (response.success) {
//                 message.success("Business Verified Successfully!");
//                 // Remove the approved item from the list instantly (Optimistic UI)
//                 setData((prevData) => prevData.filter((item) => item._id !== id));
//             } else {
//                 message.error(response.message || "Failed to verify");
//             }
//         } catch (error) {
...
//                         loading={actionLoading === record._id} // Show spinner only on clicked button
...
//                         onClick={() => message.info("Reject functionality to be implemented")}
//                     >
//                         Reject
//                     </Button>
//                 </Space>
