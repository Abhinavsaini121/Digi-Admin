      ...
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="border border-gray-300 rounded-lg px-4 py-2 bg-white shadow-sm outline-none focus:ring-2 focus:ring-blue-500"
          >
          ...
          {/* Add Button */}
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg flex items-center gap-2 transition">
            <PlusCircle size={18} />
            Add Subcategory
          </button>
        </div>
              ...
              >
                ...
                <td className="p-4">
                  <div className="flex justify-end gap-2">
                    <button className="p-2 rounded-lg text-amber-500 hover:bg-amber-50">
                      <Edit3 size={18} />
                    </button>
