...
import {
  CreditCard, History, PlusCircle, MinusCircle, Calendar, Tag,
...
const Credits = () => {
  ...
  const [shops, setShops] = useState([
    { name: 'Modern Electronics', owner: 'Rahul Sharma', phone: '+91 98765 43210', plan: 'PRO+', expiry: '2024-12-20', status: 'Active', location: 'Mumbai • Electronics' },
    { name: 'Organic Groceries', owner: 'Anjali Gupta', phone: '+91 88776 55443', plan: 'LITE', expiry: '2024-05-10', status: 'Expired', location: 'Delhi • Grocery' },
    { name: 'Royal Furniture', owner: 'Vikram Singh', phone: '+91 77665 54433', plan: 'TRIAL', expiry: '2024-02-15', status: 'Blocked', location: 'Pune • Furniture' },
  ]);
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] p-6 font-sans text-slate-800 relative">
      ...
      {/* HEADER */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-slate-900">Admin Credits Dashboard</h1>
              ...
              <tbody>
                {transactions.map((t) => (
                  <tr key={t.id} className="border-b border-gray-50 last:border-0 hover:bg-gray-50">
                    ...
                    <td className="p-3">
                      <span className={`px-2 py-1 rounded-md text-xs font-medium ${t.type === 'Purchase' ? 'bg-green-100 text-green-700' :
